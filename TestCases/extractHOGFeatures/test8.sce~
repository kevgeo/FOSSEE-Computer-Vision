...
values = extractHOGFeatures(I1,"CellSize",[16,4],"BlockSize",[8,8],"BlockOverlap",[16,8],"NumBins",9);
//output-> CellSize values cannot be more than BlockSize values.

//Reading image
I2 = imread("lena.jpeg");
//Extracting HOG feature values from image
values = extractHOGFeatures(I2,"CellSize",[16,4],"BlockSize",[8,8],"BlockOverlap",[16,8],"NumBins",9);
//output-> CellSize values cannot be more than BlockSize values.
